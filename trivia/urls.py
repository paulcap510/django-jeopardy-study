...
urlpatterns = [
    ...
    path('api/entries/<int:entry_id>/delete/', views.api_delete_entry, name='api_delete_entry'),
    path('api/entries/<int:entry_id>/edit/', views.api_edit_entry, name='api_edit_entry'),
